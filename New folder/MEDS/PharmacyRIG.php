...
<div class="left">
        <h1>Welcome</h1>
        <h6>Pharmacy, Lets cure people</h6>
        </div>
</div>
    <div class="container">
            ...
            <form action="PharmacyRIG.php" method="post">
                <div class="user-details">
                    ...
                    <div class="input-box">
                        ...
                        <input type="text"  pattern="[6789]{1}[0-9]{9}"  name="PHONE" placeholder="Enter your phone number" value="<?php echo $PHONE; ?>" required>
                    </div>
                    <div class="input-box">
                    ...
                    <div class="input-box">
                        ...
                        <input type="password" pattern="(?=.\d)(?=.[a-z])(?=.*[A-Z]).{8,}" name="password" placeholder="Ex:Swaroop@3" value="<?php echo $_POST['password']; ?>" required>
                    </div>
                </div>
