            ...
            <form action="DoctorRIG.php" method="post">
                <div class="user-details">
                    <div class="input-box">
                        ...
                        <input class="input" type="text" name="D_NAME" placeholder="Enter your name" value="<?php echo $D_NAME; ?>" required>
                    </div>
                    <div class="input-box">
                        <span class="details">Clinic</span>
                        <input class="input"  type="text"  name="CLINIC"    placeholder="Enter your Clinic" value="<?php echo $CLINIC; ?>" required>
                    </div>
                    <div class="col-10">
                ...
                <div class="col-90"> 
                    ...
                    <div class="input-box">
                        ...
                        <input class="input" type="text"  pattern="[6789]{1}[0-9]{9}"  name="PHONE" placeholder="Enter your number" value="<?php echo $PHONE; ?>" required>
                    </div>
                    <div class="input-box">
                        <span class="details">Email</span>
                        <input class="input" type="email"  name="email" placeholder="Enter your email" value="<?php echo $email; ?>" required>
                    </div>
                    <div class="input-box">
                        <span class="details">Password</span>
                        <input class="input" type="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}"  name="password" placeholder="Enter your password" value="<?php echo $_POST['password']; ?>" required>
                    </div>
                </div>
