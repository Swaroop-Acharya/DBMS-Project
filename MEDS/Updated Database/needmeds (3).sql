...
(6, ' John', 20, 'Male', 'Banglore', 9794665, 45, 20, 'john@gmail.com', 'b8b4b727d6f5d1b61fff7be687f7970f'),
(7, ' Ashish', 20, 'MALE', 'Banglore', 5354, 48, 20, 'ashish@gmail.com', 'b8b4b727d6f5d1b61fff7be687f7970f');
...
--
ALTER TABLE `patient`
  MODIFY `PAT_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
