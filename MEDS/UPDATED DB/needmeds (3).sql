...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 29, 2022 at 03:26 PM
...
(11, ' sdd', 18, 'MALE', 'KADRI', 5444, 44, NULL, 'sdd@gmail.com', 'b8b4b727d6f5d1b61fff7be687f7970f'),
(12, ' Swaroop', 19, 'Male', 'BANGLORE', 878789, 46, 29, 'swaroop@gmail.com', 'b8b4b727d6f5d1b61fff7be687f7970f');
...
(29, 'Swaroop Medicals ', 'BANGLORE', 'swarooplearns@gmail.com', 8878787, 'b8b4b727d6f5d1b61fff7be687f7970f');
...
--
ALTER TABLE `patient`
  MODIFY `PAT_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `prescription`
  MODIFY `PR_ID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `patient`
  ADD CONSTRAINT `Y` FOREIGN KEY (`D_ID`) REFERENCES `doctor` (`D_ID`) ON DELETE SET NULL ON UPDATE CASCADE,
  ADD CONSTRAINT `dd` FOREIGN KEY (`P_ID`) REFERENCES `pharmacy` (`P_ID`) ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE `prescription`
  ...
  ADD CONSTRAINT `A2` FOREIGN KEY (`D_ID`) REFERENCES `doctor` (`D_ID`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `A3` FOREIGN KEY (`P_ID`) REFERENCES `pharmacy` (`P_ID`) ON DELETE NO ACTION ON UPDATE CASCADE;
